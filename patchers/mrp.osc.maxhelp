...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 3.0, 222.0, 20.0 ],
					"text" : "(c) 2023 Michael Maria Ott, MIT License"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.0, 8.0, 203.0, 194.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 88.0, 111.0, 114.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "mrp.osc.maxpat",
				"bootpath" : "~/Projects/iil-mrp-tools/MaxMSP/mrp.osc/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../../../Documents/Max 8/Packages/mrp.osc/code",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
